...
@section('title', 'Find Medicare Coverage – American Life Insurance')
@section('content')
<section class="medicare_section">
    <div class="container px-5rem">
        <div class="form_div mx-auto">
            <div id="multi-step-form-container">
                <!-- Step Wise Form Content -->
                <form id="myForm" action="{{ route('medicare_save')}}" method="POST">
                    @csrf
                    ...
                    <section id="step-5" class="form-step tab">
                        ...
                        <div class="mt-1em">
                            ...
                            <label id="zip-error" class="error" for="zip" style="display: none;"></label>
                        </div>
                    </section>
                    <!-- Step 6 Content, default hidden on page load. -->
                    <section id="step-6" class="form-step tab">
                        <h2 class="form_label">Last Step! </h2>
                        <!-- Step 5 input fields -->
                        <div class="mt-1em">
                            <div class="form-group">
                        ...
                        <div class="mt-1em">
                            <div class="form-group">
                                <input type="checkbox" id="agree" class="p1 inputfiled checkboxfiled">
                    ...
                    <!-- <div class="thanks-message text-left" id="text-message" style="display: none;"> <img
                            src="./img/check.png" width="100" class="mb-4">
